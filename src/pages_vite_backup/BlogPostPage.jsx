      ...
      <div className="min-h-screen bg-[#0B1220] flex flex-col font-sans text-slate-200">
        ...
        <main className="flex-grow flex items-center justify-center">
          <div className="text-center space-y-4">
            ...
            <Link to="/blog" className="text-blue-400 hover:underline inline-flex items-center text-xs font-bold uppercase font-mono tracking-wider">
    ...
    <div className="min-h-screen bg-[#0B1220] flex flex-col font-sans text-slate-200 overflow-x-hidden selection:bg-blue-500/30">
      ...
      <main className="flex-grow">
        ...
        <div className="max-w-3xl mx-auto px-8 py-16 text-left">
          <Link to="/blog" className="inline-flex items-center text-blue-400 font-bold uppercase font-mono tracking-wider text-[10px] hover:text-blue-300 mb-10 transition">
