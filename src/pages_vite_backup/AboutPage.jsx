      ...
      <section className="py-24 px-8 border-t border-slate-800/80 max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-16">
          <div className="lg:w-1/3 text-left space-y-4">
            ...
            <h2 className="text-3xl font-extrabold text-white leading-tight">Meet the Builders</h2>
          ...
          <div className="lg:w-2/3 flex flex-col gap-12">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
              <div className="w-32 h-32 rounded-full overflow-hidden bg-[#E2B671] border border-slate-800 shrink-0 shadow-lg">
                <img src={mudassarImg} alt="Muhammad Mudassar" className="w-full h-full object-cover object-top" />
              </div>
              <div className="mt-2 space-y-2">
                <h3 className="text-xl font-bold text-white">Muhammad Mudassar</h3>
                <p className="text-xs text-blue-400 font-semibold font-mono uppercase tracking-wider">Frontend Architect & UI/UX Designer</p>
            ...
            {/* Person 2 (Ammar) */}
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
              <div className="w-32 h-32 rounded-full overflow-hidden bg-slate-800 border border-slate-850 shrink-0 shadow-lg">
                <img src={ammarImg} alt="Ammar Haider" className="w-full h-full object-cover object-top" />
              </div>
              <div className="mt-2 space-y-2">
                <h3 className="text-xl font-bold text-white">Ammar Haider</h3>
                <p className="text-xs text-blue-400 font-semibold font-mono uppercase tracking-wider">Backend Lead & Systems Engineer</p>
                <p className="text-xs text-slate-400 leading-relaxed max-w-md">
            ...
            <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
              <div className="w-32 h-32 rounded-full overflow-hidden bg-slate-800 border border-slate-850 shrink-0 shadow-lg">
                <img src={muneerImg} alt="Muneer Hussain" className="w-full h-full object-cover object-top" />
              </div>
              <div className="mt-2 space-y-2">
                <h3 className="text-xl font-bold text-white">Muneer Hussain</h3>
                <p className="text-xs text-blue-400 font-semibold font-mono uppercase tracking-wider">ML Engineer & Model Assessor</p>
                <p className="text-xs text-slate-400 leading-relaxed max-w-md">
        ...
        <div className="max-w-4xl mx-auto text-left space-y-12">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 text-center sm:text-left">
            <div className="w-24 h-24 rounded-full overflow-hidden bg-slate-800 border border-slate-850 shrink-0 shadow-lg">
              <img src={mariyamImg} alt="Dr. Maryam Nawaz" className="w-full h-full object-cover object-top" />
            </div>
